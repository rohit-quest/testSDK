                  ...
                  {screenshot !== null &&
                    (
                      <div className="q-fdov-file-name" style={{
                        display: "flex", justifyContent: "space-between", alignItems: "center", border: "1px solid #ECECEC", borderRadius: "10px", padding: "10px 10px", marginTop: "10px"
                      }}>
                        <p style={{
                          fontSize: "14px",
                          width: "fit-content",
