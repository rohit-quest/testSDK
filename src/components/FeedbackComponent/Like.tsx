...
function Like({
  ...
  return (
    <div className={styles.feedbackNumbering} style={{...style}}>
        <div className={isLike != 0 ? null:styles.feedbackNumberingSelected} onClick={() => updateValue(0)} style={{...(isLike ? buttonStyle:selectedButtonStyle)}}>
        ...
        <div className={isLike != 1 ? null:styles.feedbackNumberingSelected} onClick={() => updateValue(1)} style={{...(isLike ? selectedButtonStyle:buttonStyle)}}>
