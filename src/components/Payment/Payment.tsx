        ...
        >
          {tiers.map((tier, index) => (
            ...
            >
              ...
              >
                {tier.creditsTierName.toLowerCase().includes(" plan")
              ...
              <div
                ...
                style={{ color: `${modifyDesigns.fontColor}` }}
              >
                <p className="q-pynt-main-div-div-p">${tier.creditsAmount}</p>
              ...
              <p className="q-pynt-main-div-div-p3">FEATURES</p>
              <div className=" q-pynt-main-div-div-chDiv">
                ...
                {!!paymentBanefits[index] &&
                  ...
                  paymentBanefits[index].notIncluded.map(
                    (banefits: string, i: number) => (
                      <div className="q-pynt-main-div-div-chDiv-ben2" key={i}>
                        <img
                          src={untick}
                          style={{ width: "1.25rem", height: "1.25rem" }}
                        />
                        <p style={{ color: "#9CA3AF" }}>{banefits}</p>
                      </div>
                    )
                  )}
              </div>
