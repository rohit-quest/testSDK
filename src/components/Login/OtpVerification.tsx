    ...
    <div className="questLabs">
      <div style={{ boxSizing: "content-box" }} className="embeded-otp">
        ...
        <div className="q_outer_cont">
          <div
            className="q_otp_main_cont"
            style={{ background: styleConfig?.IconStyle?.BorderColor }}
          >
            <div
              className="q_otp_cont"
              style={{ background: styleConfig?.IconStyle?.Background }}
            >
              ...
              renderInput={(props) => (
                ...
                >
                  <input
                    ...
                    style={{
                      backgroundColor:
                        styleConfig?.OtpInput?.backgroundColor || "transparent",
                      borderColor:
                        styleConfig?.OtpInput?.borderColor ||
