    ...
    const normalInput = (
        ...
        return (
            <div key={criteriaId}>
                ...
                <Label htmlFor="normalInput" style={{ color: styleConfig?.Label?.color || BrandTheme?.primaryColor || themeConfig?.primaryColor, ...styleConfig?.Label }}>
                    {`${question} ${!!required ? "*" : ""}`}
                </Label>
                <Input
                    type={inputType}
                    ...
                    iconColor={styleConfig?.Input?.color || BrandTheme?.primaryColor || themeConfig?.primaryColor || "#B9B9B9"}
        ...
        return (
            <div key={criteriaId}>
                ...
                <SingleChoice
                    ...
                    selectedStyle={{
                        accentColor: styleConfig?.SingleChoice?.selectedStyle?.accentColor || questThemeData?.accentColor || BrandTheme?.accentColor || themeConfig?.primaryColor,
                                    ...
                                    <div className="q-onb-main-criteria">
                                        {
                                            ...
                                            <SecondaryButton
                                                style={{
                                                    ...
                                                    background: styleConfig?.SecondaryButton?.backgroundColor ||  themeConfig?.backgroundColor,
