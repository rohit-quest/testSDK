...
export const createDefaultQuest = async (
    ...
    try {
        ...
        let body = {
                ...
                [
                    ...
                    },
                    {
                        ...
                        data: {
                            ...
                            linkActionUrl:
                                "https://main.d2h2uj2sjo2c2h.amplifyapp.com/",
                            effort: "E1",
                            importance: "I1",
                            xp: 10,
                            frequency: "ONCE",
                    ...
                    },
                    {
                        ...
                        data: {
                            ...
                            linkActionUrl:
                                "https://www.linkedin.com/company/questlabss/",
                            effort: "E1",
                            importance: "I1",
                            xp: 10,
                            frequency: "ONCE",
            ...
            type: "HELPHUB",
            questDetails: [
                { title: "Helphub Feedback", description: "Helphub Feedback", endsAt: endsAtDate},
                { title: "Helphub FAQ", description: "Helphub FAQ", endsAt: endsAtDate},
                { title: "Helphub Updates", description: "Helphub Updates", endsAt: endsAtDate},
                { title: "Helphub Tasks", description: "Helphub Tasks", endsAt: endsAtDate},
            ],
        };
        ...
        if (responseObj?.success) {
            let getQuestResponse = await getDefaultQuest(backend_url, entityId, responseObj?.parentId, userId, token, apikey)
