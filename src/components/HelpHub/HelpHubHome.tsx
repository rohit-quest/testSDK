        ...
        <div className={"helpHubMainInnerCont"} style={styleConfig?.Home?.Form}>
            ...
            <div style={{ width: "100%" }} className="q-helphub-InnerCont">
                <div className={"HelloCont"}>
                    <div
                        className={"HelloText"}
                        style={styleConfig?.Home?.BannerText}
                    >
                ...
                {/* get  updates */}
                <div
                    className="q-helphub-update-mainCont"
                ...
                >
                    {/* one */}
                    <div
                        className="q-helphub-compProfile-text-con"
                ...
                <div
                    className={`q-helphub-review ${
                        showFeedback && "q-show-feedback"
                    }`}
                    style={{
                        background: themeConfig?.backgroundColor,
                        ...styleConfig?.Home?.Card,
