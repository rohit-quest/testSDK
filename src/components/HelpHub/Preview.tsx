...
export default function HelpHubPreview({ online = true }) {
    ...
    const [parentQuest,setParentQuest]=useState<QuestTypes>({
        ...
        categories:[],
        childQuestIDs:["q-6958228a-5238-48f0-9394-6d146f540324",
    ...
    if (online){
        return (
            ...
            >
                 <HelpHub
                    token={'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiJ1LWExYjhmNGFiLTAxYjktNGZmNS1iZmU3LTZlYzM3NzBmOGJkYSIsImlhdCI6MTcxMjM3ODI3MiwiZXhwIjoxNzEyOTgzMDcyfQ.uW1uHrxDUySnCWiBdNoqcPKmOAX2eoQcWC9PCvcIi7w'} 
                    userId="u-a1b8f4ab-01b9-4ff5-bfe7-6ec3770f8bda"
