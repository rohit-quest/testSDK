...
const Tutorial: React.FC<TutorialProps> = ({
  ...
  return (
    <div className="q-parent-container" style={{ display: !minimze ? "flex" : "none" }}>
      {showLoader && <Loader />}
      <ToastContainer />
            ...
            <div className='q-tut-bar-icons'>
              <span onClick={() => setMin(true)}>
                <svg width="24" height="24" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9.33334 28C9.33334 27.0717 9.70208 26.1815 10.3585 25.5251C11.0148 24.8687 11.9051 24.5 12.8333 24.5H43.1667C44.0949 24.5 44.9852 24.8687 45.6415 25.5251C46.2979 26.1815 46.6667 27.0717 46.6667 28C46.6667 28.9283 46.2979 29.8185 45.6415 30.4749C44.9852 31.1313 44.0949 31.5 43.1667 31.5H12.8333C11.9051 31.5 11.0148 31.1313 10.3585 30.4749C9.70208 29.8185 9.33334 28.9283 9.33334 28Z" fill="#AFAFAF" />
                </svg>
              </span>
                  ...
                  <div style={{ display: 'flex', gap: "20px", alignItems: "center" }}>
                    {!completedSteps.includes(index) ? (
                      <svg width="25" height="25" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect x="2" y="2" width="44" height="44" rx="8" stroke="#E2E2E2" stroke-width="4" />
                      </svg>
                    ) : (
                      <svg width="30" height="30" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M28.2667 43.2L47.0667 24.4L43.3333 20.6667L28.2667 35.7333L20.6667 28.1333L16.9333 31.8667L28.2667 43.2ZM13.3333 56C11.8667 56 10.6107 55.4773 9.56534 54.432C8.52 53.3867 7.99823 52.1316 8 50.6667V13.3333C8 11.8667 8.52267 10.6107 9.568 9.56534C10.6133 8.52 11.8684 7.99823 13.3333 8H50.6667C52.1333 8 53.3893 8.52267 54.4347 9.568C55.48 10.6133 56.0018 11.8684 56 13.3333V50.6667C56 52.1333 55.4773 53.3893 54.432 54.4347C53.3867 55.48 52.1316 56.0018 50.6667 56H13.3333Z" fill="black" />
                      </svg>
                    )}
