  ...
  const dislike = (
    ...
    >
      ...
      <rect
        ...
        height="38.5"
        rx="19.25"
        transform="matrix(-1 8.74228e-08 8.74228e-08 1 38.5 6.55671e-08)"
        stroke="#AFAFAF"
        stroke-width="1.5"
      />
    </svg>
    ...
    >
      {formdata.length > 0 ? (
        formdata[0].type !== "LIKE_DISLIKE" ? (
          <>
            {!thanksPopup && (
              <div>
                <TopBar
                  heading={
                    (sections && sections[page]?.heading) || heading || ""
                  }
                  description={
          ...
          <div className="">
            {!likePopup && (
              <div className="q-fd-like-dislike">
                <div className="q-fd-like-dislike-txt">
                  <div>Are these results helpful?</div>
                  <div>Your feedback helps us improve search results</div>
                </div>
                <div className="like-dislike-cont">
                  <div
          ...
          <div className="">
            <div className="mb-4">
              <label className="q-fd-lebels">Rating Scale</label>
