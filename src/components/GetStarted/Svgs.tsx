...
export const arrowRight = (color: string="#939393") => createUrl(`<svg width="25" height="25" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const downArroIcon = (color: string="#939393") => createUrl(`<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
